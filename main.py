...
#
# # Callback
# eval_callback = EvalCallback(env, best_model_save_path="./logs/BestModel1/",
#                              log_path="./logs/BestModel1/", eval_freq=500,
#                              deterministic=True, render=False)
#
# # Train the agent and display a progress bar
# model.learn(
#     total_timesteps=int(1e6),
#     tb_log_name='Unprotected_intersection_turn_left_DQN_1M_call',
#     progress_bar=True,
#     callback=eval_callback
# )
#
# # Save the agent
# model.save("Unprotected_intersection_turn_left_DQN_1M_call")
# del model  # delete trained model to demonstrate loading
# #
# # Load the trained agent
# # NOTE: if you have loading issue, you can pass `print_system_info=True`
# # to compare the system on which the model was trained vs the current one
# model = DQN.load("Unprotected_intersection_turn_left_DQN_1M_call", env=env)
#
# print(model.policy)
#
#
